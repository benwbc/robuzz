...
export default function ReportModal({ targetType, targetId, targetLabel, onClose }) {
  ...
  return (
    <div
      ...
      onClick={(e) => {
        // Stop here so a backdrop click doesn't also bubble up to a
        // clickable ancestor (a post card opens this modal and navigates
        // to the post on click, which a naive backdrop-click would trigger).
        e.stopPropagation();
        onClose();
      }}
    >
