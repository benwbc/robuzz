...
// Includes fields only the account owner (or an admin) should see. Discord
// linkage stays private here (unlike Roblox linking, which is shown on the
// public profile by design) since it's a sign-in method, not a badge.
